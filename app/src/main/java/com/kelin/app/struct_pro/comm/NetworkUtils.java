...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        MyApp.getInstance().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
...
//    }
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) CommUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) CommUtils.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) CommUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
