...
public class ImageUtils {
    ...
    public static void showImageView(Context context, String url,
        ...
        Glide.with(context).load(url)// 加载图片
               // .error(errorimg)// 设置错误图片
                ...
                .placeholder(R.drawable.shape_load_error_img)// 设置占位图
     ...
     * @param imgeview 组件
     */
    public static void showImageViewToCircle(Context context, int errorimg, ImageView imgeview) {
        Glide.with(context).load(errorimg)
                // 加载图片
               // .error(errorimg)
                // 设置错误图片
                .crossFade()
