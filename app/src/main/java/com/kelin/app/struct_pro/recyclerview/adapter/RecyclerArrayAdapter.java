package com.kelin.app.struct_pro.recyclerview.adapter;
...
import com.kelin.app.struct_pro.recyclerview.event.DefaultEventDelegate;
import com.kelin.app.struct_pro.recyclerview.event.EventDelegateAble;
...
abstract public class RecyclerArrayAdapter<T> extends RecyclerView.Adapter<BaseViewHolder>   {
    ...
    private static void log(String content){
        if (RefreshRecyclerView.DEBUG){
            Log.i(RefreshRecyclerView.TAG,content);
        }
    }
}
