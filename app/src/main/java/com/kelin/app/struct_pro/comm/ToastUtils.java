...
public final class ToastUtils {
    ...
    private  void show(@StringRes final int resId, final int duration) {
        show(CommUtils.getApp().getResources().getText(resId).toString(), duration);
    }

    private  void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(CommUtils.getApp().getResources().getString(resId), args), duration);
    }
    ...
    private  View getView(@LayoutRes final int layoutId) {
